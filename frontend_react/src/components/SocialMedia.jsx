...
const SocialMedia = ({ theme, switchTheme }) => {
  ...
  return (
    <div className="app__social">
      ...
      <a
        href="https://www.linkedin.com/in/brandon-schumacher/"
        target="_blank"
        rel="noreferrer"
      ...
      <a href="mailto:btschu@icloud.com" title="Email Me" aria-label="Email Me">
        <button>
          <AiOutlineMail />
        </button>
        <span>Email</span>
      ...
      {isVisible && (
        <a href="#home" title="Scroll to top" aria-label="Scroll to top">
          <button>
            <AiOutlineArrowUp />
          </button>
          <span>To Top</span>
